...
class PrivacyPolicy extends React.Component {
  render() {
    ...
    <PrivacyStyle>
      ...
      <div className="ink-flex push-center card">
        <div className="large-50 small-95">
          <div className="content">
            <div className="main-title">Privacy Policy</div>
            <div className="title">WHAT DO WE DO WITH YOUR INFORMATION?</div>
            ...
            <div className="sub-title">How do you get my consent?</div>
            <div className="description">
            ...
            <div className="description">We may disclose your personal information if we are required by law to do so or if you violate our Terms of Service.</div>
            ...
            <div className="title">QUESTIONS AND CONTACT INFORMATION</div>
            <div className="description">
