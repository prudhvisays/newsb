      ...
      <div className="ink-flex second-boxShadow tab-second-row">
        <div className="all-100">
          <div className="ink-flex vertical">
            <div className="fw-500 sub-title">{Title}</div>
            <div>{name}</div>
          </div>
          <div className="ink-flex">
            <div className="all-50">
              <div className="tab-block ink-flex vertical">
                <div className="fw-500 sub-title">Phone</div>
                <div>{phone}</div>
              </div>
            </div>
            <div className="all-50">
              <div className="tab-block ink-flex vertical">
                <div className="fw-500 sub-title">Mail</div>
                <div>{email}</div>
              </div>
            </div>
            <div className="all-100">
              <div className="tab-block ink-flex vertical">
                <div className="fw-500 sub-title">Address</div>
                <div>{address}</div>
              </div>
            </div>
          </div>
